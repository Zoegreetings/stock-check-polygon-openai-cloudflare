  ...
  try {
    const stockData = await Promise.all(
      tickersArr.map(async (ticker) => {
        const url = `https://polygon-stock.zenggreetings.workers.dev/?ticker=${ticker}&startDate=${dates.startDate}&endDate=${dates.endDate}`;
...
async function fetchReport(data) {
  ...
  try {
    const url = "https://cloudflaretrialworker.zenggreetings.workers.dev";
